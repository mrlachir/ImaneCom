...
class HomeController extends Controller
{
    ...
    {
        $nb_clients = Statistic::where('name', 'clients')->select('numbers')->first();
        return $nb_clients;
    }
    private function getYearsExperience()
    {
        $years_experience = Statistic::where('name', 'years experience')->select('numbers')->first();
        return $years_experience;
    }
    private function getNbProjectsFinished()
    {
        $nb_projects_finished = Statistic::where('name', 'projects finished')->select('numbers')->first();

             ...
             <div class="col-lg-3 col-md-6">
                 ...
                 <div class="d-flex pt-2">
                     <a class="btn btn-square btn-outline-secondary rounded-circle me-1"
                         href="{{ $company->facebook_url }}"><i class="fab fa-twitter"></i></a>
                     <a class="btn btn-square btn-outline-secondary rounded-circle me-1"
                         href="{{ $company->twitter_url }}"><i class="fab fa-facebook-f"></i></a>
                     <a class="btn btn-square btn-outline-secondary rounded-circle me-0"
                         href="{{ $company->insta_url }}"><i class="fab fa-instagram"></i></a>
                 </div>
             </div>
             <div class="col-lg-3 col-md-6">
         ...
         <div class="container">
             <div class="row">
                 ...
                 <div class="col-md-6 text-center text-md-end">
                     Designé par <a href="https://sykweb.net" target="_blank">SYKWEB</a>
                 </div>
             </div>
         </div>
     </div>

        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="./service.html">
                    ...
                    <span class=" mb-1 text-uppercase text-lg text-white font-weight-bolder opacity-8 d-block p-2"> Dashboard
                    </span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="./company.html">
            ...
            <li class="nav-item">
                <a class="nav-link text-white active " href="./profile.html">

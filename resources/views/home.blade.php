            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="fact-item bg-light rounded text-center h-100 p-5">
                        ...
                        <h1 class="display-5 mb-0" data-toggle="counter-up">{{$years_experience->numbers}}</h1>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="fact-item bg-light rounded text-center h-100 p-5">
                        ...
                        <h1 class="display-5 mb-0" data-toggle="counter-up">{{$nb_clients->numbers}}</h1>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="fact-item bg-light rounded text-center h-100 p-5">
                        ...
                        <h1 class="display-5 mb-0" data-toggle="counter-up">{{$nb_projects_finished->numbers}}</h1>
                    </div>
                </div>
            </div>
        </div>
